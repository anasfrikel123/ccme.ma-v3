[Skip to main content](https://developers.google.com/search/blog/2025/05/succeeding-in-ai-search#main-content)
...
Make sure your pages meet our [technical requirements for Google Search](https://developers.google.com/search/docs/essentials/technical),
...
[`noindex`](https://developers.google.com/search/docs/crawling-indexing/block-indexing) to set your
...
[Structured data](https://developers.google.com/search/docs/appearance/structured-data/search-gallery) is useful for
sharing information about your content in a machine-readable way that our systems consider and
makes pages eligible for [certain search features and rich results](https://developers.google.com/search/docs/appearance/structured-data/search-gallery).
If you're using structured data, be sure to [follow our guidelines](https://developers.google.com/search/docs/appearance/structured-data/sd-policies),
...
high-quality [images](https://developers.google.com/search/docs/appearance/google-images) and
[videos](https://developers.google.com/search/docs/appearance/video) on your pages, and ensure that your
[Merchant Center](https://support.google.com/merchants/answer/12159157)
and [Business Profile](https://developers.google.com/search/docs/appearance/establish-business-details) information
is up-to-date.
...
To learn even more, see our new help pages: [AI features and your site](https://developers.google.com/search/docs/appearance/ai-features)
...
Posted by [John Mueller](https://developers.google.com/search/blog/authors/john-mueller), Google Search Relations
