...
keywords:
  - "fermer société Maroc"
  - "dissolution liquidation SARL Maroc"
  - "radiation registre de commerce"
  - "cessation activité société Tanger"
related:
  - "creer-sarl-tanger-2026"
  - "domiciliation-societe-tanger"
  - "sarlau-vs-sarl-vs-sas"
about:
  - "/services/dissolution-liquidation-societe"
  - "/services/travaux-juridiques"
---
...
C'est le miroir exact des formalités de [création d'entreprise](/services/creation-entreprise), et cela relève de nos [travaux juridiques](/services/travaux-juridiques).
...
Cette phase s'appuie sur une [comptabilité](/services/tenue-comptabilite) tenue jusqu'au dernier jour.
...
- la **dernière liasse [IS](/outils/simulateur-is "Simulateur IS Maroc")** et la régularisation de la [TVA](/outils/simulateur-tva) ;
- l'imposition éventuelle du **boni de liquidation** ;
- le solde des comptes [CNSS](/services/damancom-cnss).

La [DGI](/services/simpl-impots-dgi) regarde de près les cessations : un dossier bâclé attire le contrôle. Mieux vaut une clôture carrée, préparée comme on préparerait un [contrôle fiscal](/services/controle-contentieux).

## Fermer n'est pas toujours la meilleure option

Avant de tout arrêter, posez-vous la question : une **mise en sommeil** temporaire, une **cession** de la société via une [transmission](/services/evaluation-transmission-entreprise), ou une restructuration ne serviraient-elles pas mieux vos intérêts ? Parfois, ce qui ressemble à une impasse a une porte de sortie plus rentable.

## En résumé

Fermer une société au Maroc, c'est trois étapes — dissolution, liquidation, radiation — doublées d'une clôture fiscale qui exige de la méthode. Faite proprement, la fermeture vous libère définitivement. Bâclée, elle vous poursuit pendant des années. Si vous envisagez de fermer, parlons-en : notre page [dissolution & liquidation de société](/services/dissolution-liquidation-societe) détaille notre accompagnement, et le premier [échange est gratuit](/contact).
