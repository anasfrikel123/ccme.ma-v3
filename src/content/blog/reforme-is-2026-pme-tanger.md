...
answer: "La réforme rapproche progressivement les taux d'IS d'ici 2026, avec 20 % sur le bénéfice jusqu'à 100 MDH et un taux supérieur au-delà, la cotisation minimale et la CSS restant à intégrer. Pour la plupart des PME tangéroises, l'enjeu est d'anticiper l'effet sur les acomptes et la trésorerie."
category: "Fiscalité"
...
heroImage: "/images/blog/reforme-is-2026.jpg"
related:
...
- Sociétés en zone franche ([TFZ](/zones/tanger-free-zone), [TAC](/zones/tanger-automotive-city), [Tanger Tech](/zones/tanger-tech)) après les 5 ans d'exo : 8,75 % sur l'export
...
- **[Cotisation minimale](/glossaire#cotisation-minimale)** : taux unifié à 0,25 % du CA, minimum 3 000 DH par exercice. Vous payez le plus élevé entre la CM et l'IS calculé sur le résultat.
...
Si on peut vous aider à modéliser ça pour votre cas, on est joignables au cabinet. Premier échange offert via notre [page contact](/contact). Pour aller plus loin, nos services [conseil fiscal](/services/conseil-fiscal) et [tenue comptable](/services/tenue-comptabilite) couvrent l'accompagnement annuel en routine.
