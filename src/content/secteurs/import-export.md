...
keywords:
  ...
  - "TVA export Tanger Med"
  - "comptable Tanger Med"
heroImage: "/images/secteurs/import-export.jpg"
bullets:
  - "Conformité Office des Changes"
  - "Domiciliation bancaire des dossiers d'import"
  - "TVA export et remboursement de crédit"
  - "Prix de transfert intra-groupe"
  - "Documentation douanière et auditrice"
faq:
  - q: "Comment récupérer le crédit de TVA d'une société 100% export ?"
    a: "Demande de remboursement à la DGI, dossier électronique sur Simpl Impôts, justificatifs export (DUM, bons de livraison, factures, attestations). Délai officiel 90 jours, en pratique 4-8 mois selon la disponibilité du contrôleur. On suit le dossier et on relance régulièrement."
---

[Tanger Med](/zones/tanger-med), c'est le 1<sup>er</sup> port d'Afrique. Pour les sociétés qui importent ou exportent, c'est un atout énorme — mais aussi une couche de complexité administrative et fiscale supplémentaire.
