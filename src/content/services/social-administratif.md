...
order: 3
keywords:
  - "gestion sociale Tanger"
  - "inspection travail Tanger"
  - "règlement intérieur Maroc"
  - "contentieux prud'homal Tanger"
heroImage: "/images/services/social-administratif.jpg"
bullets:
...
faq:
  - q: "Le règlement intérieur est-il obligatoire ?"
    a: "Oui à partir de 10 salariés. Il doit être communiqué à l'inspection du travail et affiché dans les locaux. Sans règlement intérieur, vos sanctions disciplinaires sont fragiles juridiquement."
  - q: "Que faire si un salarié saisit les prud'hommes ?"
    a: "Pas de panique. On prépare le dossier (contrat, bulletins, preuves de la procédure disciplinaire si applicable, témoignages). On travaille avec un avocat spécialisé en droit social. La conciliation est tentée d'abord — souvent c'est là que tout se règle, sans aller au jugement."
